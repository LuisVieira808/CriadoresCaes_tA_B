...
namespace CriadoresCaes_tA_B.Models {
   ...
   public class Criadores {
      ...
      [RegularExpression("[1-9][0-9]{3}-[0-9]{3}( [a-zA-Z-]+áÁçÇ)+")]
      ...
      [RegularExpression("(00)?([0-9]{2,3})?[1-9][0-9]{8}", ErrorMessage ="Escreva um nº Telemóvel com 9 algarismos. Se quiser, pode acrescentar o indicativo nacional e o internacional. ")]
